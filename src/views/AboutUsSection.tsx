    ...
    return (
        <section className="relative flex flex-col md:flex-row items-center justify-between w-full px-8 md:px-20 overflow-hidden bg-transparent">
            ...
            >
                ...
                <h3 className="text-3xl md:text-4xl font-bold leading-snug text-black">
            ...
            >
                <motion.div
                    className="relative w-[360px] md:w-[360px] h-[440px] overflow-hidden droplet-shape bg-transparent"
                >
                    <Image
